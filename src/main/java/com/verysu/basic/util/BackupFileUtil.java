...
import com.verysu.basic.model.BackupFile;
...
public class BackupFileUtil {
	...
	public void backup(String name) {
		...
		try {
			...
			tagu.tarFile(bp,realPath+File.separator+backupFile+File.separator+new SimpleDateFormat("yyyy-MM-dd-HHmmss").format(new Date())+"_"+name+".tar");
		} catch (IOException e) {
			e.printStackTrace();
		} finally {
			try {
